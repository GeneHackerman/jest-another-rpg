...
Game.prototype.startNewBattle = function() {
    ...
    // this will display stats as a table
...
// methods are being recalled as they are tested and passed
// if any bugs, game logic is at fault
                ...
                if (action === 'Use potion') {
                    ...
                    inquirer 
                        ...
                        .then(({ action }) => {
                            ...
                            this.player.userPotion(potionDetails[0] - 1);
